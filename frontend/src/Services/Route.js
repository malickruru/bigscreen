...
export { login, logout,  listQuestion, addQuestion, deleteQuestion, addAnswer, listAnswerByUser, AtypeData, qualityData, listAnswer, listSurvey, addSurvey, releaseSurvey, editSurvey, deleteSurvey,onlineSurvey }